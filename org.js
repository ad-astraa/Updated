...
function setup() {
  ...
  palette.push(new Atom('C', 50, 50, color(100, 100, 100))); 
  palette.push(new Atom('H', 50, 100, color(200, 200, 200))); 
  palette.push(new Atom('O', 50, 150, color(255, 0, 0))); 
  palette.push(new Atom('N', 50, 200, color(0, 0, 255))); 
  palette.push(new Atom('S', 50, 250, color(255, 255, 0))); 
}
